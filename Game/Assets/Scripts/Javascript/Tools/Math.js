...
{
	if(!(_v1n instanceof(Vector))) PrintErr("Parameter Normalized Vector in DotProduct");
	if(!(_v2n instanceof(Vector))) PrintErr("Parameter Normalized Vector in DotProduct");
